 ...
 */
public class ExtUtilizationModelPlanetLabInMemory implements UtilizationModel {
	 ...
	 */
	public ExtUtilizationModelPlanetLabInMemory(String inputPath, double schedulingInterval)
	 ...
	 * @throws IOException Signals that an I/O exception has occurred.
	 */
	public ExtUtilizationModelPlanetLabInMemory(String inputPath, double schedulingInterval, int dataSamples)
			throws NumberFormatException,
			IOException {
		setSchedulingInterval(schedulingInterval);
